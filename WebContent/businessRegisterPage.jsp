...
<%@ page import="javax.servlet.*" import="javax.servlet.http.*" import="java.lang.*"%>
		...
		<div class="col-md-6 offset-3 grid-margin stretch-card">
			<div class="card">
				<div class="card-body mb-0">
					...
					<p class="fw-bold fw-lighter text-primary" style="font-size:18px;">Notice that You are creating account for your Business.</p>	
					<%
					...
					%>
					<form action="businessRegister.jsp" method="post" class="forms-sample">
						...
						<div class="d-flex justify-content-between mt-5 mb-0 p-0">
							...
							<a class="ms-3 text-decoration-none" href="/Amono/WebContent/loginPage.jsp">Login
								Here</a>
							</div>
							<a class="ms-3  text-decoration-none" href="/Amono/WebContent/registerPage.jsp">
							Just create normal account</a>
						</div>
					</form>
				</div>
			</div>

...
@MultipartConfig
public class businessDetailRegister extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userId != null) {
			switch (authRoleId) {
			case 1:
				response.sendRedirect("http://localhost:8080/Amono/WebContent/User/index.jsp");
				break;
			case 2:
			...
			try {
				...
				if (!businessName.isEmpty() && !businessDescription.isEmpty()
					...
					forwardPage = "/WebContent/business.jsp";
				}
				if (row < 1) {
					...
					forwardPage = "/WebContent/business.jsp?error="
							+ validCheck;
				} else {
